...
export function AppLayout({ children }: { children: React.ReactNode }) {
	...
	return (
		<div
			// screen (plain vh, the large viewport) rather than svh, for the same
			// reason as body in styles.css: the small viewport is short of the screen
			// in a home-screen app, and the tab bar sits against whichever one the
			// document fills.
